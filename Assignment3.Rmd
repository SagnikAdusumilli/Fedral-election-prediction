...
* There does not seem to be an significant difference in the number of awswered the survey for each province. This indicates that this survey represents the data of each province fairly well. 
\newpage
```{r, echo = FALSE}
gss_common_data %>% 
  tab_cells("**Sex**" = sex, 
