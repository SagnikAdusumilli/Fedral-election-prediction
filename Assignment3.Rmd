...
kable(d2, 
      ...
      caption = c("Comparing Age variable in both dataset"), align = "c")
```
From this table, we can see that household size thas similar distributions, however CES data seems to indicate that people in this dataset tend to have more household members. The max size 15 could be a potential outlier 
