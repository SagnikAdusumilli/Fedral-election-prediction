...
Some of the important terminologies is the Majority government.It refers to one or multiple governing parties that hold an absolute majority of seats in a legislature. This is opposed to a minority government, where the largest party in a legislature only has a plurality of seats. A government majority determines the balance of power. Also, some of the parties mentioned below are Bloc Quebecois, Conservatives, Greens, Liberal, NDP, and People’s Party.

The main objective of this paper is to investigate which factors from the survey data can be applied to the census data to stratify the general population by the party they vote for. Using this we can predict which party is more likely to get elected for each province. Furthermore, we could also predict if the government for 2025 election is a minority or majority government
